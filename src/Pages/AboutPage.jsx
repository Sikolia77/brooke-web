      ...
      <div className="aboutSections">
        <section className="aboutPage section-1">
          <div className="text-main">
            ...
            <p>
              The data portal is our one stop platform that allows you to
              access, visualize and analyze our collections of data. The portal
              helps our users save time by availing useful, relevant and easy to
              understand sets of data. It also provides spatial data analysis
              and visualization (also known as GIS) capabilities. <br />
          ...
          <div className="container">
            ...
            <div>
              ...
              <p>
                ...
                portal allows export generation of PDF reports from its
